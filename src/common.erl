...
-export_records(['common_Vendor-Specific-Application-Id']).

-record('common_Vendor-Specific-Application-Id',
...
name2rec('Vendor-Specific-Application-Id') ->
    'common_Vendor-Specific-Application-Id';
...
dict() ->
	...
	["Vendor-Id", "Auth-Application-Id", "User-Name",
     ...
     {messages, []}, {name, "common"}, {prefix, "common"},
     {vendor, {10415, "3GPP"}}].
